...
public class LoginForm extends javax.swing.JFrame {
    ...
    String password = new String(jPasswordFieldRegister.getPassword());
    
    try {
        boolean success = RegisterController.Register(username, password);
        if (!success) {
            // Notify error if registration fails
            JOptionPane.showMessageDialog(this, "Username already exists. Please try again.", "Registration Error", JOptionPane.ERROR_MESSAGE);
        } else {
        ...
        JOptionPane.showMessageDialog(this, "An error occurred. Please try again later.", "System Error", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
    }
